...
import com.itisacat.basic.framework.dao.model.PageRequest;
...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        ...
        SqlSessionFactory targetSqlSessionFactory = targetSqlSessionFactorys.get(DataSourceSwitch.getDataSource());
    ...
    public <K, V> Map<K, V> selectMap(String statement, Object parameter, String mapKey) {
    	if(parameter instanceof PageRequest) {
    		PageRequest<?> pr = (PageRequest<?>)parameter;
    		return this.sqlSessionProxy.<K, V>selectMap(statement, pr.getParamData(), mapKey,
    				new RowBounds(pr.getPageNum(), pr.getPageSize()));
    	}
    ...
    public <E> List<E> selectList(String statement, Object parameter) {
    	if(parameter instanceof PageRequest) {
    		PageRequest<?> pr = (PageRequest<?>)parameter;
    		return this.sqlSessionProxy.<E>selectList(statement, pr.getParamData(), 
    				new RowBounds(pr.getPageNum(), pr.getPageSize()));
    	}
